...
public abstract class AbstractMonitorConnection extends MonitorWrapperImpl implements MonitorConnection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new MonitorPreparedStatementImpl(targetConnection.prepareStatement(sql),dbMonitor,sql);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return new MonitorPreparedStatementImpl(targetConnection.prepareStatement(sql,resultSetType,resultSetConcurrency),dbMonitor,sql);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,resultSetType,resultSetConcurrency,resultSetHoldability),dbMonitor,sql);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,autoGeneratedKeys),dbMonitor,sql);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,columnIndexes),dbMonitor,sql);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,columnNames),dbMonitor,sql);
    }
