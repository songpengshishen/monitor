...
public abstract class AbstractMonitorConnection extends MonitorWrapperImpl implements MonitorConnection {
    ...
    public Statement createStatement() throws SQLException {
        return new MonitorStatementImpl(targetConnection.createStatement());
    }

    @Override
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new MonitorPreparedStatementImpl(targetConnection.prepareStatement(sql));
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        return new MonitorStatementImpl(targetConnection.createStatement(resultSetType,resultSetConcurrency));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return new MonitorPreparedStatementImpl(targetConnection.prepareStatement(sql,resultSetType,resultSetConcurrency));
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new MonitorStatementImpl(this.targetConnection.createStatement(resultSetType,resultSetConcurrency,resultSetHoldability));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,resultSetType,resultSetConcurrency,resultSetHoldability));
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,autoGeneratedKeys));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,columnIndexes));
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,columnNames));
    }
