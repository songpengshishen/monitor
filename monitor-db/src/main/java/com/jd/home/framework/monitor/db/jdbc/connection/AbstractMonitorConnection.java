...
public abstract class AbstractMonitorConnection extends MonitorWrapperImpl implements MonitorConnection {
    ...
    public Statement createStatement() throws SQLException {
        return new MonitorStatementImpl(targetConnection.createStatement(),monitorConfig);
    }

    @Override
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new MonitorPreparedStatementImpl(targetConnection.prepareStatement(sql),monitorConfig);
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        return new MonitorStatementImpl(targetConnection.createStatement(resultSetType,resultSetConcurrency),monitorConfig);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return new MonitorPreparedStatementImpl(targetConnection.prepareStatement(sql,resultSetType,resultSetConcurrency),monitorConfig);
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new MonitorStatementImpl(this.targetConnection.createStatement(resultSetType,resultSetConcurrency,resultSetHoldability),monitorConfig);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,resultSetType,resultSetConcurrency,resultSetHoldability),monitorConfig);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,autoGeneratedKeys),monitorConfig);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,columnIndexes),monitorConfig);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new MonitorPreparedStatementImpl(this.targetConnection.prepareStatement(sql,columnNames),monitorConfig);
    }
