...
/**
 * Title : 抽象的监控PreparedStatement实现
 * Description: 通过目标PreparedStatement实现 {@link PreparedStatement}方法  </br>
...
public abstract class AbstractMonitorPreparedStatement extends MonitorWrapperImpl implements MonitorPreparedStatement {
    ...
    public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        ...
        try {
            sqlRecord = dbMonitor.SlowSqlMonitorStart(sql);
            flag =  preparedStatement.executeUpdate(sql,autoGeneratedKeys);
        }catch (Throwable t){
            dbMonitor.SqlErrorMonitor(sqlRecord,t);
            throw t;
        }finally {
    ...
    public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
        ...
        try {
            sqlRecord = dbMonitor.SlowSqlMonitorStart(sql);
            flag =  preparedStatement.executeUpdate(sql,columnIndexes);
        }catch (Throwable t){
            dbMonitor.SqlErrorMonitor(sqlRecord,t);
            throw t;
        }finally {
    ...
    public int executeUpdate(String sql, String[] columnNames) throws SQLException {
        ...
        try {
            sqlRecord = dbMonitor.SlowSqlMonitorStart(sql);
            flag =  preparedStatement.executeUpdate(sql,columnNames);
        }catch (Throwable t){
            dbMonitor.SqlErrorMonitor(sqlRecord,t);
            throw t;
        }finally {
    ...
    public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        ...
        try {
            sqlRecord = dbMonitor.SlowSqlMonitorStart(sql);
            flag =  preparedStatement.execute(sql,autoGeneratedKeys);
        }catch (Throwable t){
            dbMonitor.SqlErrorMonitor(sqlRecord,t);
            throw t;
        }finally {
    ...
    public boolean execute(String sql, int[] columnIndexes) throws SQLException {
        ...
        try {
            sqlRecord = dbMonitor.SlowSqlMonitorStart(sql);
            flag =  preparedStatement.execute(sql,columnIndexes);
        }catch (Throwable t){
            dbMonitor.SqlErrorMonitor(sqlRecord,t);
            throw t;
        }finally {
    ...
    public boolean execute(String sql, String[] columnNames) throws SQLException {
        ...
        try {
            sqlRecord = dbMonitor.SlowSqlMonitorStart(sql);
            flag =  preparedStatement.execute(sql,columnNames);
        }catch (Throwable t){
            dbMonitor.SqlErrorMonitor(sqlRecord,t);
            throw t;
        }finally {
